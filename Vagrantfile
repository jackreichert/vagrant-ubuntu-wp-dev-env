...
Vagrant.configure(2) do |config|
  ...
  config.vm.synced_folder "./html", "/var/www/html"#, owner: 'vagrant', group: 'www-data', mount_options: ["dmode=775", "fmode=664"], create: true # this only works on vagrant reload
